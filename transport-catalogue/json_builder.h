...
namespace json {
	...
	class Builder
	{
		// ¬спомогательные классы строителей дл€ построени€ JSON 

		class BaseBuilder;
		class DictBuilder;
		class ArrayBuilder;

		//  лассы-контексты дл€ ограничени€ вызова невалидных методов
		// класса Builder в определенном состо€нии
	...
	private:
		...
		// –одительский класс "базового" строител€
		class BaseBuilder {
		public:

			virtual ~BaseBuilder() = default;

			// Ќичего не делает, служит дл€ переопределени€ в DictBuilder
			...
			// Ќичего не делает, служит дл€ переопределени€ в ArrayBuilder
		...
		//  ласс дл€ создани€ словар€ json::Dict
		...
		//  ласс дл€ создани€ вектора json::Array
